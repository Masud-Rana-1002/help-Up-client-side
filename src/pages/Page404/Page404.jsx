...
const Page404 = () => {
    ...
    return (
        <div className="boxShadow max-h-dvh px-10 w-full lg:flex-row gap-[30px] lg:gap-0 flex-col flex items-center justify-evenly py-20 rounded-xl">
            ...
            <div className="w-full lg:w-[30%] text-center lg:text-start">
                ...
                <button className="py-3 px-6 sm:px-8 text-[0.9rem] sm:text-[1rem] rounded-full bg-[#566FA7] text-white mt-8"><Link to='/'>Back to
                homepage</Link>
                </button>
            </div>
        </div>
